      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            Ready to take the next step? Fill out the form below to get a free, no-obligation quote for your pickleball court project.
          </p>
        </div>
          ...
          <form action="#" method="POST" className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
            ...
            <div className="flex gap-x-4 sm:col-span-2">
              <div className="flex h-6 items-center">
                <input
                  id="agreed-to-policies"
                  name="agreed-to-policies"
                  type="checkbox"
                  className="h-4 w-4 rounded border-gray-300 text-blue-600 focus:ring-blue-600"
                />
              </div>
              <label htmlFor="agreed-to-policies" className="text-sm leading-6 text-gray-600">
