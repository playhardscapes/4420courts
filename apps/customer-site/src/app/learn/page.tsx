      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-md p-8 mb-12">
            <h2 className="text-2xl font-bold font-heading text-gray-900 mb-6">Pickleball Basics</h2>
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-lg font-semibold font-heading text-gray-900 mb-4">The Game</h3>
              ...
              <div>
                <h3 className="text-lg font-semibold font-heading text-gray-900 mb-4">Basic Rules</h3>
                <ul className="text-gray-700 space-y-2">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="bg-white rounded-lg shadow-md p-6 text-center">
              ...
              <h3 className="text-lg font-semibold font-heading mb-2">Easy to Learn</h3>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 text-center">
              ...
              <h3 className="text-lg font-semibold font-heading mb-2">Low Impact</h3>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 text-center">
              ...
              <h3 className="text-lg font-semibold font-heading mb-2">Fast Paced</h3>
          ...
          {/* Equipment Guide */}
          <div className="bg-white rounded-lg shadow-md p-8 mb-12">
            <h2 className="text-2xl font-bold font-heading text-gray-900 mb-6">Getting Started: Equipment</h2>
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-lg font-semibold font-heading text-gray-900 mb-4">Essential Gear</h3>
              ...
              <div>
                <h3 className="text-lg font-semibold font-heading text-gray-900 mb-4">Paddle Selection Tips</h3>
          ...
          <div className="bg-white rounded-lg shadow-md p-8">
            <h2 className="text-2xl font-bold font-heading text-gray-900 mb-6">Beginner Strategy Tips</h2>
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-lg font-semibold font-heading text-gray-900 mb-4">Court Positioning</h3>
                <ul className="text-gray-700 space-y-2">
              ...
              <div>
                <h3 className="text-lg font-semibold font-heading text-gray-900 mb-4">Shot Selection</h3>
                <ul className="text-gray-700 space-y-2">
          ...
          <div className="text-center mt-12">
            <div className="bg-blue-50 rounded-lg p-8">
              <h3 className="text-xl font-bold font-heading text-gray-900 mb-4">Ready to Build Your Court?</h3>
